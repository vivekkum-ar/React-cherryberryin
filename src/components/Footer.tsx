          ...
          <div className="grid grid-cols-3 gap-8 sm:gap-6 sm:grid-cols-3 mx-2 sm:mx-0">
            ...
            <div>
              ...
              <ul className="text-gray-600 dark:text-gray-400 font-medium">
                ...
                <li className="mb-4">
                  <Link to="https://github.com/vivekkum-ar/React-cherryberryin" className="hover:underline ">Facebook</Link>
                </li>
                <li className="mb-4">
                  <Link to="https://github.com/vivekkum-ar/React-cherryberryin" className="hover:underline ">Instagram</Link>
                </li>
                <li className="mb-4">
                  <Link to="https://github.com/vivekkum-ar/React-cherryberryin" className="hover:underline ">Twitter</Link>
                </li>
                <li>
