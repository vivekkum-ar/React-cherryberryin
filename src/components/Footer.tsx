...
const Footer: React.FC<FooterProps> = ({ }) => {
  ...
  <div className="grid w-screen absolute top-10 top-0 bottom-0">
        <div className="justify-self-center md:justify-self-start opacity-25 w-64 h-80" style={{ backgroundImage: `url("/images/logo.png")`, backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
        </div>
      </div>
