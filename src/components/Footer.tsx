interface FooterProps {
  ...
  <footer className="bottom-0 bg-white dark:bg-gray-900">
    <div className="grid w-screen md:translate-y-64 translate-y-96">
          <div className="justify-self-center md:justify-self-start grayscale opacity-25 w-64 h-80" style={{backgroundImage:`url("/images/logo.png")`, backgroundRepeat:"no-repeat", backgroundSize:"cover"}}>
          </div>
          </div>
          ...
          <div className="mx-auto w-full max-w-screen-xl sm:px-6 py-6 lg:py-8">
              ...
              <div className="grid grid-cols-3 gap-8 sm:gap-6 sm:grid-cols-3 mx-2 sm:mx-0">
                <div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                    <li className="mb-4">
                      <a href="/" className="hover:underline">CherryBerry.in</a>
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                    <li className="mb-4">
                      <a href="https://github.com/themesberg/CherryBerry.in" className="hover:underline ">Github</a>
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                    <li className="mb-4">
                      <a href="/legal/privacypolicy" className="hover:underline">Privacy Policy</a>
                    </li>
                    <li>
            ...
            <div className="flex flex-col sm:flex-row items-center sm:justify-between">
              <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/" className="hover:underline">CherryBerry.in™</a>. All Rights Reserved.
              </span>
