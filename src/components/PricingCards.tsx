          ...
          <div className="flex overflow-hidden md:flex-row flex-col md:gap-8 md:mx-20 mx-5 ">
            <div className="pricing-card md:w-1/3 w-full py-4 px-4 dark:bg-gray-900">
              <div className="pricingTable">
                ...
                <a href="#" className="dark:bg-blue-700 inline-flex justify-center items-center py-2 px-5 font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                  Contact Us
            ...
            <div className="pricing-card md:w-1/3 w-full py-4 px-4">
              <div className="pricingTable red">
                ...
                <a href="#" className="dark:bg-blue-700 inline-flex justify-center items-center py-2 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                  Contact Us
                  <svg className="w-3.5 h-3.5 ml-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M1 5h12m0 0L9 1m4 4L9 9" />
                  </svg>
