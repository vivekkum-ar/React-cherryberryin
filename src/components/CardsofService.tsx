...
const CardofService: React.FC<CardofServiceProps> = ({title,description}) => {
  return (
    ...
    <span className="absolute top-4 z-0 h-12 md:h-20 w-12 md:w-20 rounded-full bg-sky-500 transition-all duration-300 group-hover:scale-[10]" />
    <div className="relative z-10 mx-auto max-w-md">
      <span className="grid h-12 md:h-20 w-12 md:w-20 place-items-center rounded-full bg-sky-500 transition-all duration-300 group-hover:bg-sky-400">
