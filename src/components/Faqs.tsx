  ...
  <div className="parent-faqs-title border-2 border-red-500 flex flex-col place-content-center bg-white dark:text-white bg-white dark:bg-gray-900 overflow-hidden">
    ...
    <div className="max-w-3xl mx-auto mt-8 space-y-4 md:mt-16">
      <div className="transition-all duration-200 bg-white border border-gray-200 shadow-lg cursor-pointer hover:bg-gray-50">
        ...
        <div id="answer1" className={`${openPanelIndex[0] == true ? "" : "hidden"} px-4 pb-5 sm:px-6 sm:pb-6`}>
      ...
      <div className="transition-all duration-200 bg-white border border-gray-200 shadow-lg cursor-pointer hover:bg-gray-50">
        ...
        <div id="answer2" className={`${openPanelIndex[1] == true ? "" : "hidden"} px-4 pb-5 sm:px-6 sm:pb-6`}>
      ...
      <div className="transition-all duration-200 bg-white border border-gray-200 shadow-lg cursor-pointer hover:bg-gray-50">
        ...
        <div id="answer3" className={`${openPanelIndex[2] == true ? "" : "hidden"} px-4 pb-5 sm:px-6 sm:pb-6`}>
      ...
      <div className="transition-all duration-200 bg-white border border-gray-200 shadow-lg cursor-pointer hover:bg-gray-50">
        ...
        <div id="answer4" className={`${openPanelIndex[3] == true ? "" : "hidden"} px-4 pb-5 sm:px-6 sm:pb-6`}>
