...
{/* <div className="relative"> */}
  <div className="max-w-screen-xl mx-auto" style={{backgroundImage:`url("./images/about1.jpg")`}}>
    ...
    <div id="parent-services-page-title" className="parent-services-page-title flex flex-col place-content-center dark:text-white overflow-hidden">
          <p className="my-5 font-bg text-center services-page-title dark:text-white mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl pb-3 overflow-hidden">
          Mission & Values
          </p>
          <hr className="services-page-title w-60 md:w-fit md:px-60 mb-5 self-center h-0 border-2 border-gray-400" />
          <p className="services-page-title mb-8 px-4 md:px-20 text-justify text-lg font-normal dark:text-white lg:text-xl text-black font-bg">Explore the extensive array of services we offer, thoughtfully crafted to meet diverse requirements, guaranteeing a seamless and flourishing online experience.</p>
          
        </div>
    </div>
    {/* <div className="py-2 max-w-screen-lg mx-auto">
    <p className="text-lg text-gray-400 dark:text-white font-bg leading-relaxed mb-4">
    At CherryBerry, we are driven by a clear mission and unwavering core values that set us apart.
  </p>
  <ul className="list-disc pl-6">
    <li className="mb-2 dark:text-white text-gray-400">Our Mission:</li>
  <ul className="list-disc pl-6">
    <li className="ml-4 text-gray-400 dark:text-white font-bg">Empowering individuals and businesses through innovative online solutions.</li>
    </ul>
    <li className="mb-2 dark:text-white text-gray-400">Core Values:</li>
    <ul className="list-disc">
    <li className="ml-4 text-gray-400 dark:text-white font-bg">Integrity: Upholding honesty and transparency in all our interactions.</li>
    <li className="ml-4 text-gray-400 dark:text-white font-bg">Excellence: Striving for excellence in every aspect of our work.</li>
    <li className="ml-4 text-gray-400 dark:text-white font-bg">Innovation: Embracing creativity and staying at the forefront of technology.</li>
  </ul>
  </ul>
  </div> */}
  ...
  <section className=" py-10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="bg-white p-3 font-bg rounded-xl ">
...
<section className="bg-white dark:bg-gray-900 pb-6 font-bg">
        <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
          ...
          <p className="my-6 font-bg text-center services-page-title dark:text-white bg-white dark:bg-gray-900 mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl py-6 overflow-hidden">
          ...
          <hr className="services-page-title w-60 md:w-fit md:px-60 mb-5 self-center h-0 border-2 border-gray-400" />
            ...
            <div className="flex flex-wrap my-0">
              <div className="w-full border-b border-black dark:border-gray-200 md:w-1/2 md:border-r lg:w-1/3 p-8">
              ...
              <div className="w-full border-b border-black dark:border-gray-200 md:w-1/2 lg:w-1/3 lg:border-r p-8">
                <div className="flex items-center mb-6">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width={20} height={20} fill="currentColor" className="h-6 w-6 text-blue-700">
                    <path d="M16 3C8.8 3 3 8.8 3 16s5.8 13 13 13 13-5.8 13-13c0-1.398-.188-2.793-.688-4.094L26.688 13.5c.2.8.313 1.602.313 2.5 0 6.102-4.898 11-11 11S5 22.102 5 16 9.898 5 16 5c3 0 5.695 1.195 7.594 3.094L25 6.688C22.7 4.386 19.5 3 16 3zm11.281 4.281L16 18.563l-4.281-4.282-1.438 1.438 5 5 .719.687.719-.687 12-12z">
                    </path>
              ...
              <div className="w-full border-b border-black dark:border-gray-200 md:w-1/2 md:border-r lg:w-1/3 lg:border-r-0 p-8">
                <div className="flex items-center mb-6">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width={20} height={20} fill="currentColor" className="h-6 w-6 text-blue-700">
                    <path d="M16 3C8.8 3 3 8.8 3 16s5.8 13 13 13 13-5.8 13-13c0-1.398-.188-2.793-.688-4.094L26.688 13.5c.2.8.313 1.602.313 2.5 0 6.102-4.898 11-11 11S5 22.102 5 16 9.898 5 16 5c3 0 5.695 1.195 7.594 3.094L25 6.688C22.7 4.386 19.5 3 16 3zm11.281 4.281L16 18.563l-4.281-4.282-1.438 1.438 5 5 .719.687.719-.687 12-12z">
                    </path>
              ...
              <div className="w-full border-b border-black dark:border-gray-200 md:w-1/2 lg:w-1/3 lg:border-r lg:border-b-0 p-8">
                <div className="flex items-center mb-6">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width={20} height={20} fill="currentColor" className="h-6 w-6 text-blue-700">
                    <path d="M16 3C8.8 3 3 8.8 3 16s5.8 13 13 13 13-5.8 13-13c0-1.398-.188-2.793-.688-4.094L26.688 13.5c.2.8.313 1.602.313 2.5 0 6.102-4.898 11-11 11S5 22.102 5 16 9.898 5 16 5c3 0 5.695 1.195 7.594 3.094L25 6.688C22.7 4.386 19.5 3 16 3zm11.281 4.281L16 18.563l-4.281-4.282-1.438 1.438 5 5 .719.687.719-.687 12-12z">
                    </path>
              ...
              <div className="w-full border-b border-black dark:border-gray-200 md:w-1/2 md:border-r md:border-b-0 lg:w-1/3 lg:border-b-0 p-8">
                <div className="flex items-center mb-6">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width={20} height={20} fill="currentColor" className="h-6 w-6 text-blue-700">
                    <path d="M16 3C8.8 3 3 8.8 3 16s5.8 13 13 13 13-5.8 13-13c0-1.398-.188-2.793-.688-4.094L26.688 13.5c.2.8.313 1.602.313 2.5 0 6.102-4.898 11-11 11S5 22.102 5 16 9.898 5 16 5c3 0 5.695 1.195 7.594 3.094L25 6.688C22.7 4.386 19.5 3 16 3zm11.281 4.281L16 18.563l-4.281-4.282-1.438 1.438 5 5 .719.687.719-.687 12-12z">
                    </path>
